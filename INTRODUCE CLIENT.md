...
**1) _cobj_gmsio__.object.gmx**

```js
/*H*****************************************************************
* 프로그램 제목 : Client
* 작성일과 버전번호 : 2019.08.12 ver 0.1
*
* 프로그램의 전체적인 목적 -
* 	
*
    ...
    <event eventtype="3" enumb="1">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>///HTML5 only --- Polling the HTML5 adapter
    ...
    <event eventtype="7" enumb="68">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>///Non-HTML5 only --- Receive incoming messages
...
**2) obj_browser_scale.object.gmx**
    ...
    <event eventtype="0" enumb="0">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>window_set_size(browser_width, browser_height);
window_center()
    ...
    <event eventtype="3" enumb="0">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>if(_width != browser_width || _height != browser_height)
{
...
<object>
  ...
  <parentName>par_widget</parentName>
  <maskName>&lt;undefined&gt;</maskName>
  <events>
    <event eventtype="0" enumb="0">
      <action>
    ...
    <event eventtype="2" enumb="1">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>date = date_current_datetime();
alarm[1] = 60*60;
</string>
          </argument>
        </arguments>
    ...
    <event eventtype="8" enumb="0">
      ...
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>draw_set_font(fontClock);
draw_set_color(c_black);
draw_set_halign(fa_center);
draw_set_valign(fa_middle);
draw_text(x - 100, y + 25 - ease_out_circ(animation[0])*50, string_padding(string(hour), 2, "0"));
draw_text(x, y  + 25- ease_out_circ(animation[1])*50, string_padding(string(minute), 2, "0"));
draw_text(x + 100, y + 25 - ease_out_circ(animation[2])*50, string_padding(string(second), 2, "0"));

draw_set_color(c_gray);
draw_set_font(fnt_text);
draw_text(x, y + 25, date_date_string(date));
...
var teststr = "M";
max_lines = 1;
while (string_height(teststr) &lt; height) {
    teststr += "#M";
    max_lines++;
}
</string>
...
for (i=0; i&lt;l; i++) {
    ...
    draw_text(x, y, string_repeat("#", i) + ds_list_find_value(lines, i));
}
</string>
          </argument>
        </arguments>
...
if (active) {
    ...
    if (status == gmsio_status_connected) {
        if (room != rm_shoutbox_main)
            room_goto(rm_shoutbox_main)
    }
}
</string>
          </argument>
...
draw_set_color(c_black)
draw_text(x - width/2 + 20, y - height/2 + 20, ""
+ area + "#"
+ name + "#"
+ timestamp + "#"
    ...
    <event eventtype="3" enumb="0">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>///Keep line width in check
if (my_string != keyboard_string) {
    if (string_width("Enter your name: " + keyboard_string) &gt; width) {
    ...
    <event eventtype="8" enumb="0">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>///Draw the entry box

//Line
draw_set_font(fnt_text);
draw_set_color(c_black);
draw_text(x, y, "Enter your name: " + string_replace_all(my_string, "#", "\#") + string_repeat("|", caret_on));
    ...
    <event eventtype="9" enumb="13">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>///Submit line and clear
shoutbox_login(my_string);
my_string = "";
keyboard_string = "";
</string>
          </argument>
      ...
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>/// widget list
global.widget_list = ds_list_create();
</string>
          </argument>
        </arguments>
      </action>
    ...
    <event eventtype="8" enumb="72">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>if(mouse_x &gt; room_width-170)and(mouse_x &lt; room_width-20)and(mouse_y &gt; room_height-70)and(mouse_y &lt; room_height-20)
    over = true;
else
    over = false;
...
if(click) {
    for(var i = 0; i &lt; array_length_1d(list); i++) {
        ...
        draw_text(room_width-20-75, room_height-20-25 - (i+1)*60, list[i]);
    }
}

draw_text(room_width-20-75, room_height-20-25, "설정");
...
draw_set_font(fnt_text);
draw_set_color(c_black);
draw_text(x, y, string_replace_all(my_string, "#", "\#") + string_repeat("|", caret_on));
...
shoutbox_add_line("I said:", c_purple);
shoutbox_add_line(my_string, c_black);
shoutbox_send_line(my_string);
my_string = "";
keyboard_string = "";
</string>
          </argument>
    ...
    <event eventtype="3" enumb="0">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>scale_canvas(base_width, base_height, window_get_width(), window_get_height(), true)
</string>
          </argument>
        </arguments>
      </action>
    ...
    <event eventtype="1" enumb="0">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>ds_list_delete(global.widget_list, ds_list_find_index(global.widget_list, id));
</string>
          </argument>
        </arguments>
      </action>
    ...
    <event eventtype="2" enumb="11">
      <action>
        ...
        <arguments>
          <argument>
            <kind>1</kind>
            <string>ds_list_add(global.widget_list, id);
</string>
          </argument>
        </arguments>
      </action>
...
///string_padding(string,length,pad)
return string_repeat(argument2, argument1 - string_length(argument0)) + argument0;
```

------

**23) widget_pin_size.gml**
...
<assets>
  ...
  <NewExtensions>
    <extension index="0">extensions\GMS.IO (Alpha)</extension>
  </NewExtensions>
  <sounds name="sound"/>
  ...
  <scripts name="scripts">
    <scripts name="Shoutbox">
      <script>scripts\shoutbox_add_line.gml</script>
      <script>scripts\shoutbox_add_line_spacer.gml</script>
      <script>scripts\shoutbox_send_line.gml</script>
      <script>scripts\shoutbox_login.gml</script>
    </scripts>
    <scripts name="gmsio_main">
      <script>scripts\gmsio_status.gml</script>
      <script>scripts\gmsio_connect.gml</script>
      <script>scripts\gmsio_disconnect.gml</script>
      <script>scripts\gmsio_send_message.gml</script>
      <script>scripts\gmsio_has_message.gml</script>
      <script>scripts\gmsio_get_message.gml</script>
    </scripts>
    <scripts name="easing_library">
      <script>scripts\ease_in_quad.gml</script>
      <script>scripts\ease_out_quad.gml</script>
      <script>scripts\ease_in_out_quad.gml</script>
      <script>scripts\ease_in_cubic.gml</script>
      <script>scripts\ease_out_cubic.gml</script>
      <script>scripts\ease_in_out_cubic.gml</script>
      <script>scripts\ease_in_quartic.gml</script>
      <script>scripts\ease_out_quartic.gml</script>
      <script>scripts\ease_in_out_quartic.gml</script>
      <script>scripts\ease_in_quintic.gml</script>
      <script>scripts\ease_out_quintic.gml</script>
      <script>scripts\ease_in_out_quintic.gml</script>
      <script>scripts\ease_in_sine.gml</script>
      <script>scripts\ease_out_sine.gml</script>
      <script>scripts\ease_in_out_sine.gml</script>
      <script>scripts\ease_in_expo.gml</script>
      <script>scripts\ease_out_expo.gml</script>
      <script>scripts\ease_in_out_expo.gml</script>
      <script>scripts\ease_in_circ.gml</script>
      <script>scripts\ease_out_circ.gml</script>
      <script>scripts\ease_in_out_circ.gml</script>
      <script>scripts\ease_in_elastic.gml</script>
      <script>scripts\ease_out_elastic.gml</script>
      <script>scripts\ease_in_out_elastic.gml</script>
      <script>scripts\ease_in_back.gml</script>
      <script>scripts\ease_out_back.gml</script>
      <script>scripts\ease_in_out_back.gml</script>
      <script>scripts\ease_in_bounce.gml</script>
      <script>scripts\ease_out_bounce.gml</script>
      <script>scripts\ease_in_out_bounce.gml</script>
    </scripts>
    <script>scripts\scr_display_resize.gml</script>
    <script>scripts\scale_canvas.gml</script>
    <script>scripts\string_padding.gml</script>
    <script>scripts\event.gml</script>
    <script>scripts\widget_pin_size.gml</script>
  </scripts>
  <fonts name="fonts">
    <font>fonts\fnt_text</font>
    <font>fonts\font_text_small</font>
    <font>fonts\fontClock</font>
  </fonts>
  <objects name="objects">
    <objects name="GMSIO">
      <object>objects\__cobj_gmsio__</object>
    </objects>
    <objects name="Shoutbox">
      <object>objects\obj_controller</object>
      <object>objects\obj_console</object>
      <object>objects\obj_textbox</object>
      <object>objects\obj_login</object>
    </objects>
    <object>objects\obj_system</object>
    <object>objects\obj_browser_scale</object>
    <object>objects\par_widget</object>
    <object>objects\obj_clock</object>
    <object>objects\obj_finedust</object>
  </objects>
  <rooms name="rooms">
    <room>rooms\rm_init</room>
    <room>rooms\rm_shoutbox_connect</room>
    <room>rooms\rm_shoutbox_main</room>
  </rooms>
  <constants number="10">
    <constant name="server_ip">"127.0.0.1"</constant>
    <constant name="tcp_port">5833</constant>
    <constant name="socketio_port">5883</constant>
    <constant name="insig_login_refused">0</constant>
    <constant name="insig_login_accepted">1</constant>
    <constant name="insig_shout_relay">2</constant>
    <constant name="insig_user_leave">3</constant>
    <constant name="insig_user_join">4</constant>
    <constant name="outsig_login">0</constant>
    <constant name="outsig_shout">1</constant>
  </constants>
  <help>
    <rtf>help.rtf</rtf>
  </help>
